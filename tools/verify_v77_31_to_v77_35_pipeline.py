...
from broker.strategy_input_pipeline_v77_31_35 import load_json,digest_json
def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".");a=p.parse_args();r=Path(a.repository_root)
    s=load_json(r/"release/v77_35/output/strategy_input_pipeline_summary_v77_31_to_v77_35.json");errors=[]
