...
from live_readiness.live_readiness_pipeline_v77_91_95 import load_json,digest_json

def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".")
    a=p.parse_args();r=Path(a.repository_root).resolve()
    path=r/"release/v77_95/output/live_readiness_pipeline_summary_v77_91_to_v77_95.json"
    errors=[];doc={}
