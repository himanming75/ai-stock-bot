...
parser.add_argument(
    "--account",
    default="release/v391_05a/fixtures/sample_account.json",
)
parser.add_argument(
    "--positions",
    default="release/v391_05a/fixtures/sample_positions.json",
)
parser.add_argument(
    "--proposal",
    default="release/v391_05a/fixtures/sample_proposal.json",
)
parser.add_argument(
    "--output",
    default="release/v391_05a/actual/total_exposure_guard_result.json",
)
...
append_jsonl(
    ROOT / "release/v391_05a/actual/total_exposure_ledger.jsonl",
    result,
)
