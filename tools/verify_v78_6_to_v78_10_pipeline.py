...
from paper_event.paper_event_pipeline_v78_6_10 import load_json,digest_json

def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".")
    a=p.parse_args();r=Path(a.repository_root).resolve()
    path=r/"release/v78_10/output/paper_event_pipeline_summary_v78_6_to_v78_10.json"
    errors=[];doc={}
