...
result_path = root / "release/v139_03/actual/next_cycle_unlock_result.json"
...
checks = {
    ...
    "external_network_false": result.get("actual_external_network_used") is False,
    ...
    "state_valid": result.get("state") in {"WAIT_HANDOFF", "NEXT_CYCLE_UNLOCKED"},
}
