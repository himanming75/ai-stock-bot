...
p=Path(__file__).resolve().parents[1]/"release/op5_01_to_op5_04/actual/multi_day_validation_result.json"
...
"summary":r.get("validation_summary_written") is True,
"gate":r.get("validation_gate_written") is True,
"dashboard":r.get("dashboard_state_written") is True,
"state":r.get("state") in {
"WAIT_PILOT_START",
"MULTI_DAY_VALIDATION_IN_PROGRESS",
"MULTI_DAY_VALIDATION_DAY_RECORDED",
"MULTI_DAY_VALIDATION_COMPLETE"}}
