...
from market_data.market_data_pipeline_v78_31_35 import load_json,digest_json
def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".")
    a=p.parse_args();r=Path(a.repository_root).resolve()
    path=r/"release/v78_35/output/market_data_pipeline_summary_v78_31_to_v78_35.json"
    errors=[];doc={}
