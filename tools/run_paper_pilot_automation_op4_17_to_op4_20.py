...
def main() -> int:
    ...
    result = PaperPilotAutomationFoundation().run(
        policy_path=root/"release/op4_17_to_op4_20/input/paper_pilot_automation_policy.json",
        ...
        snapshot_collector_result_path=root/"release/dash2_05/actual/current_paper_snapshot_collector_result.json",
        cycle_plan_path=root/"release/op4_17_to_op4_20/actual/paper_pilot_cycle_plan.json",
        recovery_gate_path=root/"release/op4_17_to_op4_20/actual/paper_pilot_recovery_gate.json",
        dashboard_state_path=root/"release/op4_17_to_op4_20/actual/paper_pilot_automation_dashboard_state.json",
        result_path=root/"release/op4_17_to_op4_20/actual/paper_pilot_automation_result.json",
        execute_cycle=args.authorize_cycle,
    )
