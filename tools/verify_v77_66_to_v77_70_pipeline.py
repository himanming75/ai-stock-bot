...
from reporting.reporting_pipeline_v77_66_70 import load_json,digest_json
def main():
 p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".");a=p.parse_args();r=Path(a.repository_root)
 s=load_json(r/"release/v77_70/output/reporting_pipeline_summary_v77_66_to_v77_70.json");e=[]
