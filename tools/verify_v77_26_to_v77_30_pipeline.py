...
from broker.market_data_pipeline_v77_26_30 import load_json,digest_json
def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".");a=p.parse_args();r=Path(a.repository_root)
    s=load_json(r/"release/v77_30/output/market_data_pipeline_summary_v77_26_to_v77_30.json")
    errors=[]
