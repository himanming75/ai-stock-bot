...
from broker.portfolio_management_pipeline_v77_41_45 import load_json,digest_json
def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".");a=p.parse_args();r=Path(a.repository_root)
    s=load_json(r/"release/v77_45/output/portfolio_management_pipeline_summary_v77_41_to_v77_45.json");errors=[]
