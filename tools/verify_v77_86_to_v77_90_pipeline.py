...
from risk_stress.risk_stress_pipeline_v77_86_90 import load_json,digest_json

def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".")
    a=p.parse_args();r=Path(a.repository_root).resolve()
    path=r/"release/v77_90/output/risk_stress_pipeline_summary_v77_86_to_v77_90.json"
    errors=[];doc={}
