...
from final_system_certification.final_system_certification_pipeline_v78_91_95 import load_json,digest_json
...
def main():
    ...
    path=r/"release/v78_95/output/final_system_certification_pipeline_summary_v78_91_to_v78_95.json"
    ...
    if doc:
        ...
        if not doc.get("module_chain_head"):
            errors.append("module_chain_head")
    result={
        "verified":not errors,
