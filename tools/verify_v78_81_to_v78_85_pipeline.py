...
from deployment.deployment_pipeline_v78_81_85 import load_json,digest_json
...
def main():
    ...
    path=r/"release/v78_85/output/deployment_pipeline_summary_v78_81_to_v78_85.json"
    ...
    if doc:
        ...
        if not doc.get("manifest_sha256"):
