...
from broker.paper_runtime_pipeline_v77_16_20 import load_json,digest_json
def main():
 p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".");a=p.parse_args();r=Path(a.repository_root)
 s=load_json(r/"release/v77_20/output/paper_runtime_pipeline_summary_v77_16_to_v77_20.json")
 errors=[]
