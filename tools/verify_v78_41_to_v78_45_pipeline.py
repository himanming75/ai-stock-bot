...
from signal_risk_bridge.signal_risk_bridge_pipeline_v78_41_45 import load_json,digest_json
...
def main():
    ...
    path=r/"release/v78_45/output/signal_risk_bridge_pipeline_summary_v78_41_to_v78_45.json"
    errors=[]
    doc={}
    if not path.is_file():
