...
def main():
 ...
 root=Path(a.repository_root).resolve();out=root/"release/v83_60/output"
 ...
 print(json.dumps({"stage_range":"V83.41-V83.60","status":cert["status"],**cert["paper_order_submission_summary"],
 ...
 "live_trading_authorized":False,"paper_order_submission_simulation_complete":cert["paper_order_submission_simulation_complete"],
