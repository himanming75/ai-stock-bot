...
from paper_session.paper_session_pipeline_v78_16_20 import load_json,digest_json
def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".")
    a=p.parse_args();r=Path(a.repository_root).resolve()
    path=r/"release/v78_20/output/paper_session_pipeline_summary_v78_16_to_v78_20.json"
    errors=[];doc={}
