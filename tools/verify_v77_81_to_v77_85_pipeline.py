...
from monte_carlo.monte_carlo_pipeline_v77_81_85 import load_json,digest_json

def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".")
    a=p.parse_args();r=Path(a.repository_root).resolve()
    path=r/"release/v77_85/output/monte_carlo_pipeline_summary_v77_81_to_v77_85.json"
    errors=[];doc={}
