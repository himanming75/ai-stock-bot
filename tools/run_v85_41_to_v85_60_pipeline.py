...
def main():
 ...
 root=Path(a.repository_root).resolve();out=root/"release/v85_60/output"
 ...
 print(json.dumps({"stage_range":"V85.41-V85.60","status":cert["status"],**cert["paper_order_authorization_summary"],
 "network_requests_executed":0,"credentials_used":0,"trading_client_created":False,"actual_orders_submitted":0,
 "paper_order_authorization_ready":cert["paper_order_authorization_ready"],
 "paper_order_submission_authorized":False,"live_trading_authorized":False,
 "paper_order_authorization_complete":cert["paper_order_authorization_complete"],
