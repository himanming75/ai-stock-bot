...
from execution_coordinator.execution_coordinator_pipeline_v78_51_55 import load_json,digest_json
...
def main():
    ...
    path=r/"release/v78_55/output/execution_coordinator_pipeline_summary_v78_51_to_v78_55.json"
