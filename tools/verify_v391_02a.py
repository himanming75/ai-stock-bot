...
path = ROOT / "release/v391_02a/actual/daily_loss_guard_result.json"
...
checks = {
    "stage": result.get("stage") == "V391.02A",
    ...
    "loss_pct_present": isinstance(evaluation.get("daily_loss_pct"), (int, float)),
    "limit_present": isinstance(evaluation.get("daily_loss_limit_pct"), (int, float)),
