...
path = ROOT / "release/v391_07a/actual/kill_switch_guard_result.json"
...
checks = {
    "stage": result.get("stage") == "V391.07A",
    ...
    "kill_switch_required": evaluation.get("kill_switch_required") is True,
