...
from market_clock.market_clock_pipeline_v78_26_30 import load_json,digest_json
def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".")
    a=p.parse_args();r=Path(a.repository_root).resolve()
    path=r/"release/v78_30/output/market_clock_pipeline_summary_v78_26_to_v78_30.json"
    errors=[];doc={}
