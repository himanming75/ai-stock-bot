...
from audit_reconciliation.audit_reconciliation_pipeline_v78_66_70 import load_json,digest_json
...
def main():
    ...
    path=r/"release/v78_70/output/audit_reconciliation_pipeline_summary_v78_66_to_v78_70.json"
