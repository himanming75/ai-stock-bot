...
from portfolio_runtime.portfolio_runtime_pipeline_v78_46_50 import load_json,digest_json
...
def main():
    ...
    path=r/"release/v78_50/output/portfolio_runtime_pipeline_summary_v78_46_to_v78_50.json"
    errors=[]
    doc={}
    if not path.is_file():
