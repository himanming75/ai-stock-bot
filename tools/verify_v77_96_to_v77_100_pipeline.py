...
from broker_integration.broker_integration_pipeline_v77_96_100 import load_json,digest_json

def main():
    p=argparse.ArgumentParser();p.add_argument("--repository-root",default=".")
    a=p.parse_args();r=Path(a.repository_root).resolve()
    path=r/"release/v77_100/output/broker_integration_pipeline_summary_v77_96_to_v77_100.json"
    errors=[];doc={}
