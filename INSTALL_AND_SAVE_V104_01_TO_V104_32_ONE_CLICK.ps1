...
Write-Host "=== V104.01-V104.32 ONE-CLICK INSTALL ==="
...
powershell -ExecutionPolicy Bypass `
    -File .\RUN_V104_01_TO_V104_32.ps1
...
git add `
    continuous_autonomous_engine `
    tools/run_v104_01_to_v104_32.py `
    tools/test_v104_01_to_v104_32.py `
    tools/install_check_v104_01_to_v104_32.py `
    tools/verify_v104_01_to_v104_32.py `
    RUN_V104_01_TO_V104_32.ps1 `
    RUN_V104_01_TO_V104_32_TEST_AND_VERIFY.ps1 `
    INSTALL_AND_SAVE_V104_01_TO_V104_32_ONE_CLICK.ps1 `
    release/v104_01_to_v104_32 `
    V104_01_TO_V104_32_MANIFEST.json `
    GIT_COMMIT_V104_01_TO_V104_32.txt

$StagedFiles=git diff --cached --name-only
if($StagedFiles){
    git commit -m "V104.01-V104.32 continuous autonomous engine core integrated"
...
git log -1 --oneline
Write-Host "V104.01-V104.32 ONE-CLICK COMPLETE"
