...
Write-Host "=== V137.01-V139.64 AUTONOMOUS ORCHESTRATOR ONE-CLICK INSTALL ==="
...
git add autonomous_orchestrator tools/run_v137_01_to_v139_64.py `
 tools/test_v137_01_to_v139_64.py tools/install_check_v137_01_to_v139_64.py `
 tools/verify_v137_01_to_v139_64.py RUN_V137_01_TO_V139_64.ps1 `
 RUN_V137_01_TO_V139_64_TEST_AND_VERIFY.ps1 `
 INSTALL_AND_SAVE_V137_01_TO_V139_64_ONE_CLICK.ps1 `
 release/v137_01_to_v139_64 V137_01_TO_V139_64_MANIFEST.json `
 GIT_COMMIT_V137_01_TO_V139_64.txt
$staged=git diff --cached --name-only
if($staged){git commit -m "V137.01-V139.64 autonomous trading orchestrator integrated"}
Write-Host "[6/6] GIT PUSH"
if(-not $SkipPush){git push origin main}
git log -1 --oneline
Write-Host "V137.01-V139.64 ONE-CLICK COMPLETE"
