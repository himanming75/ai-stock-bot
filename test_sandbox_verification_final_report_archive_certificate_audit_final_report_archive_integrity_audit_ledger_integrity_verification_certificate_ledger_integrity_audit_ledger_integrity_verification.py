...
from test_sandbox_verification_final_report_archive_certificate_audit_final_report_archive_integrity_audit_ledger_integrity_verification_certificate_ledger_integrity_audit_ledger import (
...
from backtest.sandbox_verification_final_report_archive_certificate_audit_final_report_archive_integrity_audit_ledger_integrity_verification_certificate_ledger_integrity_audit_ledger_integrity_verification import (
    ...
    verify_sandbox_verification_final_report_archive_certificate_audit_final_report_archive_integrity_audit_ledger_integrity_verification_certificate_ledger_integrity_audit_ledger_integrity,
...
def create_source() -> Any:
    ...
    return record(
        ...
        now=datetime(2026, 7, 29, 1, 11, tzinfo=timezone.utc),
    )
...
def main() -> None:
    ...
    require(source.to_dict() == source_before, "V17.7 Source 변경")
    require(
        all(
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        require(payload["version"] == "V17.8", "저장 Version 오류")
        require(
    ...
    checks = {
        "Version is V17.8": result.version == "V17.8",
        ...
        "V17.7 certificate audit ledger source passed": (
        ...
        "Result save and load passed": payload["version"] == "V17.8",
    ...
    print("=" * 108)
    print(
        "AI STOCK BOT V17.8 SANDBOX VERIFICATION FINAL REPORT ARCHIVE "
    ...
    print("=" * 108)
    print("V17.8 VALIDATION CHECKS")
    print("-" * 108)
    for name, passed in checks.items():
        print(f"{name:<74}: {passed}")
    print("=" * 108)
    require(checks["All checks passed"], "V17.8 Validation Check 실패")
    print()
    print(
        "V17.8 sandbox verification certificate audit ledger integrity "
        "verification test completed successfully."
    )
    print(
        "V17.7 Ledger Chain, Entry Findings, 연결 Hash, 읽기 전용 검증 "
