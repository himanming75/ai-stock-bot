...
from test_sandbox_archive_audit_ledger_integrity_v18_4 import (
...
from backtest.sandbox_verification_certificate_ledger_v18_5 import (
    SandboxVerificationCertificateLedgerV185Policy,
    load_certificate_ledger_result,
    record_sandbox_verification_certificate_v18_5,
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        require(payload["version"] == "V18.5", "저장 Version 오류")
    ...
    checks = {
        "Version is V18.5": second.version == "V18.5",
        ...
        "V18.4 verification source passed": second.source_checks_passed,
        ...
        "Result save and load passed": payload["version"] == "V18.5",
    ...
    print("=" * 108)
    print(
        "AI STOCK BOT V18.5 SANDBOX VERIFICATION CERTIFICATE "
        "LEDGER TEST"
    )
    print("=" * 108)
    print("V18.5 VALIDATION CHECKS")
    print("-" * 108)
    for name, passed in checks.items():
        print(f"{name:<74}: {passed}")
    print("=" * 108)
    require(checks["All checks passed"], "V18.5 Validation Check 실패")
    print()
    print(
        "V18.5 sandbox verification certificate ledger test completed "
        "successfully."
    )
    print(
        "V18.4 Certificate Hash, Final Report 연결 Hash, Ledger Snapshot "
