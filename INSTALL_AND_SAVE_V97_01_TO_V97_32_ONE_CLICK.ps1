...
git add `
    ...
    tools/install_check_v97_01_to_v97_32.py `
    tools/verify_v97_01_to_v97_32.py `
    RUN_V97_01_TO_V97_32.ps1 `
    RUN_V97_01_TO_V97_32_TEST_AND_VERIFY.ps1 `
    INSTALL_AND_SAVE_V97_01_TO_V97_32_ONE_CLICK.ps1 `
    release/v97_01_to_v97_32 `
    V97_01_TO_V97_32_MANIFEST.json `
    GIT_COMMIT_V97_01_TO_V97_32.txt

$staged=git diff --cached --name-only
if($staged){
    git commit -m "V97.01-V97.32 paper broker adapter and safe API boundary integrated"
...
git log -1 --oneline
Write-Host "V97.01-V97.32 ONE-CLICK COMPLETE"
