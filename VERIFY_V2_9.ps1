...
& $Python -m unittest .\tests\test_runtime_shadow_certification_v2_9.py
...
if($r.contracts.broker_write_performed_by_v2_9 -ne $false){throw "BROKER WRITE"}
if($r.contracts.paper_order_submission_performed_by_v2_9 -ne $false){throw "PAPER ORDER"}
if($r.contracts.live_order_submission_performed_by_v2_9 -ne $false){throw "LIVE ORDER"}
