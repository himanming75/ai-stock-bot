...
$Text=Get-Content .\trade_outcome_audit_v36_v40\service.py -Raw
$ForbiddenCalls=@(
 '\.\s*submit_order\s*\(',
 '\.\s*cancel_order\s*\(',
 '\.\s*replace_order\s*\(',
...
Write-Host "TRADE LIFECYCLE: READ ONLY"
Write-Host "MFE/MAE: REAL INPUT ONLY"
Write-Host "POST EXIT REVIEW: READ ONLY"
Write-Host "EXECUTION QUALITY: RECORD ONLY"
Write-Host "DAILY AUDIT DATASET: READ ONLY"
