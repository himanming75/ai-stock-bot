...
from test_sandbox_verification_final_report_archive_certificate_audit_final_report_archive_integrity_audit_ledger_integrity_verification_certificate_ledger_integrity_audit_ledger_integrity_verification import (
...
from backtest.sandbox_verification_certificate_ledger_v17_9 import (
    ...
    record_sandbox_verification_final_report_archive_certificate_audit_final_report_archive_integrity_audit_ledger_integrity_verification_certificate_ledger_integrity_audit_ledger_integrity_verification_certificate,
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        require(payload["version"] == "V17.9", "저장 Version 오류")
    ...
    checks = {
        "Version is V17.9": second.version == "V17.9",
        ...
        "V17.8 verification source passed": second.source_checks_passed,
        ...
        "Result save and load passed": payload["version"] == "V17.9",
    ...
    print("=" * 108)
    print(
        "AI STOCK BOT V17.9 SANDBOX VERIFICATION FINAL REPORT ARCHIVE "
        "CERTIFICATE LEDGER TEST"
    )
    print("=" * 108)
    print("V17.9 VALIDATION CHECKS")
    print("-" * 108)
    for name, passed in checks.items():
        print(f"{name:<74}: {passed}")
    print("=" * 108)
    require(checks["All checks passed"], "V17.9 Validation Check 실패")
    print()
    print(
        "V17.9 sandbox verification certificate ledger test completed "
        "successfully."
    )
    print(
        "V17.8 Certificate Hash, Final Report 연결 Hash, 모든 Ledger "
        "Snapshot Hash 보존 및 SHA-256 Ledger Chain이 검증되었습니다."
    )
    print(
