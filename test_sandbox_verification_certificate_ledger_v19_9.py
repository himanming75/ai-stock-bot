...
from test_sandbox_verification_audit_ledger_integrity_v19_8 import (
...
from backtest.sandbox_verification_certificate_ledger_v19_9 import (
    ...
    record_sandbox_verification_certificate_v19_9,
    save_certificate_ledger_result,
    verify_certificate_ledger_chain,
)


NOW = datetime(2026, 7, 29, 11, 20, tzinfo=timezone.utc)
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        require(payload["version"] == "V19.9", "저장 Version 오류")
    ...
    checks = {
        "Version is V19.9": second.version == "V19.9",
        ...
        "V19.8 verification source passed": second.source_checks_passed,
        ...
        "Result save and load passed": payload["version"] == "V19.9",
    ...
    print("=" * 108)
    print(
        "AI STOCK BOT V19.9 SANDBOX VERIFICATION CERTIFICATE "
        "LEDGER TEST"
    )
    print("=" * 108)
    print("V19.9 VALIDATION CHECKS")
    print("-" * 108)
    for name, passed in checks.items():
        print(f"{name:<74}: {passed}")
    print("=" * 108)
    require(checks["All checks passed"], "V19.9 Validation Check 실패")
    print()
    print(
        "V19.9 sandbox verification certificate ledger test completed "
        "successfully."
    )
    print(
        "V19.8 Certificate Hash, Final Report 연결 Hash, Ledger Snapshot "
