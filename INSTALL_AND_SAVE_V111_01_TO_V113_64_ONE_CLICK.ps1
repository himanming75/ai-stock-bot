...
Write-Host "=== V111.01-V113.64 FAST TRACK C READ-ONLY ONE-CLICK INSTALL ==="
...
git add `
    live_broker_readonly `
    tools/run_v111_01_to_v113_64.py `
    tools/test_v111_01_to_v113_64.py `
    tools/install_check_v111_01_to_v113_64.py `
    tools/verify_v111_01_to_v113_64.py `
    RUN_V111_01_TO_V113_64.ps1 `
    RUN_V111_01_TO_V113_64_TEST_AND_VERIFY.ps1 `
    INSTALL_AND_SAVE_V111_01_TO_V113_64_ONE_CLICK.ps1 `
    release/v111_01_to_v113_64 `
    V111_01_TO_V113_64_MANIFEST.json `
    GIT_COMMIT_V111_01_TO_V113_64.txt

$StagedFiles=git diff --cached --name-only
if($StagedFiles){
    git commit -m "V111.01-V113.64 live broker read-only infrastructure integrated"
...
git log -1 --oneline
Write-Host "V111.01-V113.64 FAST TRACK C ONE-CLICK COMPLETE"
