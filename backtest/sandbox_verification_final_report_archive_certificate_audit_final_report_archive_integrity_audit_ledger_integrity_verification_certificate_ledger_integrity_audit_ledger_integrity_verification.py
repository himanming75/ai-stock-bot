...
OUTPUT_DIRECTORY = (
    ...
    / "output"
    / "trading_engine"
    / "sandbox_verification_certificate_audit_ledger_integrity_verification"
)
REQUIRED_VERIFICATION_TEXT = (
    "VERIFY IN MEMORY SANDBOX VERIFICATION FINAL REPORT "
    "ARCHIVE CERTIFICATE AUDIT FINAL REPORT ARCHIVE INTEGRITY AUDIT "
    "LEDGER INTEGRITY VERIFICATION CERTIFICATE LEDGER INTEGRITY "
...
class SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityPolicy:
    required_source_version: str = "V17.7"
...
@dataclass(frozen=True)
class SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerFinding:
    sequence: int
    ledger_entry_id: str
...
@dataclass(frozen=True)
class SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerCertificate:
    ...
    findings: tuple[
        SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerFinding, ...
    ]
...
@dataclass
class SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityResult:
    version: str
    created_at: str
    ...
    live_execution_authorized: bool
    verification_policy: (
        SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityPolicy
    )
    certificate: (
        SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerCertificate | None
    )
...
def verify_certificate_audit_ledger_chain(
    ...
    for expected_sequence, entry in enumerate(entries, start=1):
        ...
        if any(not hasattr(entry, name) for name in required):
            errors.append(
                f"Entry {expected_sequence}의 V17.7 구조가 올바르지 않습니다."
            )
            continue
        ...
        try:
            ...
            if previous_time and recorded_at < previous_time:
                errors.append("Audit Ledger 시간이 역순입니다.")
            previous_time = recorded_at
        except (TypeError, ValueError):
            errors.append("Audit Ledger 시간이 올바르지 않습니다.")
        if entry.audit_status != "PASSED":
            errors.append("Audit Status가 PASSED가 아닙니다.")
        if not _safe_entry(entry):
            errors.append("Audit Ledger Entry 안전장치 오류입니다.")
...
def validate_policy(
    ...
    if not isinstance(
        ...
        return ["Verification Archive Certificate Audit Ledger Integrity Policy 형식 오류입니다."]
    errors: list[str] = []
    expected = {
        "required_source_version": "V17.7",
    ...
    for name, value in expected.items():
        if getattr(policy, name) != value:
            errors.append(f"{name} 값이 V17.8 기준과 다릅니다.")
    for name in (
        ...
        if getattr(policy, name) is not True:
            errors.append(f"{name}는 V17.8에서 True여야 합니다.")
    return errors
...
def verify_verification_certificate(
    certificate: (
        SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerCertificate
    ),
) -> tuple[bool, list[str]]:
    if not isinstance(
        certificate,
...
def _empty_result(
    ...
    **checks: bool,
    ...
    return SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityResult(
        version="V17.8",
        ...
        reasons=reasons,
        warnings=[
            "V17.8는 V17.7 Certificate Audit Ledger를 읽기 전용으로 검증합니다.",
            "Broker API, 계좌, Network, 실제 주문 및 Live Execution은 차단됩니다.",
        ],
        next_actions=["V17.7 Audit Ledger Source와 입력을 확인합니다."],
    )


def verify_sandbox_verification_final_report_archive_certificate_audit_final_report_archive_integrity_audit_ledger_integrity_verification_certificate_ledger_integrity_audit_ledger_integrity(
    source: Any,
    operator: str,
    ...
    policy = (
        policy
        or SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityPolicy()
    )
    ...
    if policy_errors or input_errors:
        safe_policy = (
            ...
            else SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityPolicy()
        )
    ...
    if (
        ...
        return _empty_result(
            ...
            now,
            "FAILED",
            ["Source는 V17.7 Verification Archive Certificate Audit Ledger여야 합니다."],
            policy=True,
            input=True,
        )
    ...
    try:
        ...
        return _empty_result(
            ...
            now,
            "FAILED",
            ["V17.7 Source Entries 형식이 올바르지 않습니다."],
            policy=True,
            input=True,
        )
    ...
    if not (
        ...
        source_errors.append("정상 V17.7 Audit Ledger Source가 아닙니다.")
    if not _safe_source(source):
        source_errors.append("V17.7 Source 실행 안전장치 오류입니다.")
    if source_errors:
        return _empty_result(
            policy,
            now,
    ...
    chain_valid, chain_errors = verify_certificate_audit_ledger_chain(entries)
    ...
    for actual, expected, label in (
        ...
        (
            ...
            latest.verification_ledger_snapshot_hash,
    ...
    if operator != latest.operator:
        return _empty_result(
            ...
            now,
            "BLOCKED",
            ["Operator가 V17.7 Latest Ledger Entry와 다릅니다."],
            policy=True,
            input=True,
            source=True,
            chain=True,
    ...
    certificate_payload = {
        ...
        "latest_verification_ledger_snapshot_hash": latest.verification_ledger_snapshot_hash,
    ...
    return (
        SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityResult(
            ...
            result_status_label=(
                "Sandbox Verification Final Report Archive Certificate Audit Ledger "
            ...
            reasons=[
                f"V17.7 Certificate Audit Ledger Entry {len(entries)}개를 검증했습니다.",
                "Ledger Hash Chain, Source Linkage 및 Snapshot Hash가 유효합니다.",
            ],
            warnings=[
                "V17.8는 V17.7 Certificate Audit Ledger를 변경하지 않습니다.",
                "Broker API, 계좌, Network, 실제 주문 및 Live Execution은 차단됩니다.",
            ],
            next_actions=[
...
def save_verification_result(
    ...
    report_path = output_directory / (
        f"verification_certificate_audit_ledger_integrity_{stamp}.json"
    )
    latest_path = output_directory / (
        "latest_verification_certificate_audit_ledger_integrity.json"
    )
