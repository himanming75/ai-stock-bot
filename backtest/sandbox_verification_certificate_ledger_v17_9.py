...
from backtest.sandbox_verification_final_report_archive_certificate_audit_final_report_archive_integrity_audit_ledger_integrity_verification_certificate_ledger_integrity_audit_ledger_integrity_verification import (
    SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityResult,
...
OUTPUT_DIRECTORY = (
    ...
    / "output"
    / "trading_engine"
    / "sandbox_verification_certificate_ledger"
)
REQUIRED_LEDGER_TEXT = (
    ...
    "INTEGRITY VERIFICATION CERTIFICATE LEDGER INTEGRITY AUDIT LEDGER "
...
class SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerPolicy:
    required_source_version: str = "V17.8"
...
@dataclass(frozen=True)
class SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerEntry:
    ledger_entry_id: str
    sequence: int
    recorded_at: str
    ...
    source_certificate_audit_ledger_result_id: str
    ledger_snapshot_hash: str
    verified_entry_count: int
    latest_certificate_audit_ledger_entry_id: str
    latest_certificate_audit_ledger_entry_hash: str
...
@dataclass
class SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerResult:
    version: str
    created_at: str
    ...
    live_execution_authorized: bool
    ledger_policy: (
        SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerPolicy
    )
    entries: tuple[
        SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerEntry, ...
    ]
...
def validate_policy(
    ...
    if not isinstance(
        ...
        return ["Verification Final Report Certificate Ledger Policy 형식 오류입니다."]
    errors: list[str] = []
    expected = {
        "required_source_version": "V17.8",
    ...
    for name, value in expected.items():
        if getattr(policy, name) != value:
            errors.append(f"{name} 값이 V17.9 기준과 다릅니다.")
    if policy.maximum_ledger_entries <= 0:
        errors.append("Verification Ledger 보관 한도는 0보다 커야 합니다.")
    for name in (
        "require_operator",
        ...
        if getattr(policy, name) is not True:
            errors.append(f"{name}는 V17.9에서 True여야 합니다.")
    return errors
...
def normalize_entries(
    ...
    if not isinstance(existing, (tuple, list)):
        raise TypeError("Existing Verification Ledger는 tuple/list여야 합니다.")
    if not all(
        isinstance(
            entry,
            SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerEntry,
        ...
        raise TypeError("Existing Verification Ledger Entry 형식 오류입니다.")
...
def verify_certificate_ledger_chain(
    ...
    for expected_sequence, entry in enumerate(entries, start=1):
        ...
        if entry.verification_certificate_id in certificate_ids:
            errors.append(
                "중복 Verification Certificate ID: "
        ...
        try:
            ...
            if previous_time and recorded_at < previous_time:
                errors.append("Verification Ledger 시간이 역순입니다.")
            previous_time = recorded_at
        except (TypeError, ValueError):
            errors.append("Verification Ledger 시간이 올바르지 않습니다.")
        ...
        if any(
            ...
            errors.append("Verification Ledger Entry 안전장치 오류입니다.")
        previous_hash = entry.entry_hash
    return not errors, errors


def _safe_source(
    source: SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityResult,
) -> bool:
    return not any(
        (
...
def _result(
    ...
    reasons: list[str],
    **checks: bool,
) -> SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerResult:
    latest = entries[-1] if entries else None
    return SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerResult(
        version="V17.9",
        created_at=now.isoformat(),
        ledger_result_id=str(uuid.uuid4()),
        result_status=result_status,
        result_status_label=(
            "Sandbox Verification Final Report Archive Certificate Ledger 기록 완료"
            if result_status == "RECORDED_IN_MEMORY"
            else "Verification Certificate Ledger 차단"
            if result_status == "BLOCKED"
            else "Verification Certificate Ledger 실패"
        ),
        ...
        reasons=reasons,
        warnings=[
            "V17.9는 V17.8 Certificate Audit Verification Certificate를 기록만 합니다.",
            "Broker API, 계좌, Network, 실제 주문 및 Live Execution은 차단됩니다.",
        ],
        next_actions=[
            "Verification Certificate Ledger Hash Chain을 확인합니다.",
            "Certificate, Ledger Snapshot 및 Final Report Hash 연결을 검토합니다.",
        ],
    )


def record_sandbox_verification_final_report_archive_certificate_audit_final_report_archive_integrity_audit_ledger_integrity_verification_certificate_ledger_integrity_audit_ledger_integrity_verification_certificate(
    source: Any,
    operator: str,
    ...
    policy = (
        policy
        or SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerPolicy()
    )
    ...
    if policy_errors or input_errors:
        safe_policy = (
            ...
            else SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerPolicy()
        )
        return _result(
            safe_policy,
            now,
    ...
    if not isinstance(
        ...
        return _result(
            ...
            "FAILED",
            entries,
            ["Source는 V17.8 Verification Result여야 합니다."],
            policy=True,
            input=True,
            existing=True,
            chain=True,
    ...
    if not (
        ...
        source_errors.append("정상 V17.8 Verification Source가 아닙니다.")
    if not _safe_source(source):
        source_errors.append("V17.8 Source 실행 안전장치 오류입니다.")
    ...
    if any(
        ...
        return _result(
            ...
            "BLOCKED",
            entries,
            ["중복 Verification Certificate ID가 차단되었습니다."],
            policy=True,
            input=True,
            source=True,
            certificate=True,
    ...
    try:
        if now < datetime.fromisoformat(certificate.verified_at) or (
            entries
            ...
            return _result(
                ...
                "BLOCKED",
                entries,
                ["역순 Verification Ledger 시간이 차단되었습니다."],
                policy=True,
                input=True,
                source=True,
                certificate=True,
        ...
        return _result(
            ...
            "BLOCKED",
            entries,
            ["Certificate 또는 Ledger 시간이 올바르지 않습니다."],
            policy=True,
            input=True,
            source=True,
            certificate=True,
    ...
    payload = {
        ...
        "source_certificate_audit_ledger_result_id": (
            certificate.source_ledger_result_id
        ),
        "ledger_snapshot_hash": certificate.ledger_snapshot_hash,
        "verified_entry_count": certificate.total_ledger_entry_count,
        "latest_certificate_audit_ledger_entry_id": (
            certificate.latest_ledger_entry_id
        ),
        "latest_certificate_audit_ledger_entry_hash": (
            certificate.latest_ledger_entry_hash
        ),
        "latest_verification_ledger_snapshot_hash": (
            certificate.latest_verification_ledger_snapshot_hash
    ...
    valid, errors = verify_certificate_ledger_chain(combined)
    result = _result(
        policy,
        now,
        ...
        [
            ...
            f"현재 Verification Ledger Entry는 {len(combined)}개입니다.",
        ]
        + errors,
        policy=True,
        input=True,
...
def save_certificate_ledger_result(
    result: SandboxVerificationFinalReportArchiveCertificateAuditFinalReportArchiveIntegrityAuditLedgerIntegrityVerificationCertificateLedgerIntegrityAuditLedgerIntegrityVerificationCertificateLedgerResult,
    ...
    report_path = output_directory / (
        f"verification_certificate_ledger_{stamp}.json"
    )
    latest_path = output_directory / (
        "latest_verification_certificate_ledger.json"
    )
...
def load_certificate_ledger_result(path: Path) -> dict[str, Any]:
    payload = json.loads(path.read_text(encoding="utf-8"))
    if not isinstance(payload, dict):
        raise ValueError("Verification Certificate Ledger JSON은 object여야 합니다.")
    return payload
