...
<div class='s'>READ ONLY · 2-week / 300-trade validation · AI shadow outcome calibration · refresh 30s</div><div id='a'>Loading...</div>
<script>
...
<h2>Recent AI↔Closed-Trade Links</h2><div class='c'><table><tr><th>Entry</th><th>Symbol</th><th>AI Decision</th><th>Regime</th><th>Confidence</th><th>P/L</th><th>Linked</th></tr>${recent||'<tr><td colspan=7>No linked trades yet</td></tr>'}</table></div>`}L();
</script></body></html>"""
