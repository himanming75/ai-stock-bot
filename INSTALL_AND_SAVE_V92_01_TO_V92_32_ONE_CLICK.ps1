...
git add `
    ...
    tools/install_check_v92_01_to_v92_32.py `
    tools/verify_v92_01_to_v92_32.py `
    RUN_V92_01_TO_V92_32.ps1 `
    RUN_V92_01_TO_V92_32_TEST_AND_VERIFY.ps1 `
    INSTALL_AND_SAVE_V92_01_TO_V92_32_ONE_CLICK.ps1 `
    release/v92_01_to_v92_32 `
    V92_01_TO_V92_32_MANIFEST.json `
    GIT_COMMIT_V92_01_TO_V92_32.txt

$staged=git diff --cached --name-only
if($staged){
    git commit -m "V92.01-V92.32 AI explainability pro integrated"
...
git log -1 --oneline
Write-Host "V92.01-V92.32 ONE-CLICK COMPLETE"
