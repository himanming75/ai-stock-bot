...
from test_sandbox_verification_final_report_v18_0 import (
    create_source as create_final_source,
)
from test_sandbox_verification_final_report_v18_0 import finalize

from backtest.sandbox_final_report_archive_v18_1 import (
    SandboxFinalReportArchiveV181Policy,
    archive_sandbox_final_report_v18_1,
    load_archive_result,
    save_archive_result,
...
def main() -> None:
    ...
    require(source.to_dict() == source_before, "V18.0 Source 변경 감지")
    require_safe(first)
    ...
    unsafe_policy = SandboxFinalReportArchiveV181Policy(
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        require(payload["version"] == "V18.1", "저장 Version 오류")
    ...
    checks = {
        "Version is V18.1": second.version == "V18.1",
        ...
        "V18.0 final report source passed": second.source_checks_passed,
        "V18.0 final report hash passed": second.report_hash_checks_passed,
        ...
        "Result save and load passed": payload["version"] == "V18.1",
    ...
    print("=" * 108)
    print(
        "AI STOCK BOT V18.1 SANDBOX FINAL REPORT ARCHIVE TEST"
    )
    print("=" * 108)
    print("V18.1 VALIDATION CHECKS")
    print("-" * 108)
    for name, passed in checks.items():
        print(f"{name:<74}: {passed}")
    print("=" * 108)
    require(checks["All checks passed"], "V18.1 Validation Check 실패")
    print()
    print(
        "V18.1 sandbox final report archive test completed successfully."
    )
    print(
        "V18.0 Final Report Hash와 모든 연결 Snapshot Hash 보존, Archive "
