...
git add `
    ...
    tools/install_check_v91_33_to_v91_64.py `
    tools/verify_v91_33_to_v91_64.py `
    RUN_V91_33_TO_V91_64.ps1 `
    RUN_V91_33_TO_V91_64_TEST_AND_VERIFY.ps1 `
    INSTALL_AND_SAVE_V91_33_TO_V91_64_ONE_CLICK.ps1 `
    release/v91_33_to_v91_64 `
    V91_33_TO_V91_64_MANIFEST.json `
    GIT_COMMIT_V91_33_TO_V91_64.txt

$staged=git diff --cached --name-only
if($staged){
    git commit -m "V91.33-V91.64 parameter optimization and walk-forward tuning integrated"
...
git log -1 --oneline
Write-Host "V91.33-V91.64 ONE-CLICK COMPLETE"
