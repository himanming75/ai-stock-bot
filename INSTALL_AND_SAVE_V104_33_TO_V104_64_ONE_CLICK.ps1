...
Write-Host "=== V104.33-V104.64 ONE-CLICK INSTALL ==="
...
git add `
    continuous_service_runtime `
    tools/run_v104_33_to_v104_64.py `
    tools/test_v104_33_to_v104_64.py `
    tools/install_check_v104_33_to_v104_64.py `
    tools/verify_v104_33_to_v104_64.py `
    RUN_V104_33_TO_V104_64.ps1 `
    RUN_V104_33_TO_V104_64_TEST_AND_VERIFY.ps1 `
    INSTALL_AND_SAVE_V104_33_TO_V104_64_ONE_CLICK.ps1 `
    release/v104_33_to_v104_64 `
    V104_33_TO_V104_64_MANIFEST.json `
    GIT_COMMIT_V104_33_TO_V104_64.txt

$StagedFiles = git diff --cached --name-only
if($StagedFiles){
    git commit -m "V104.33-V104.64 continuous service runtime integrated"
...
git log -1 --oneline
Write-Host "V104.33-V104.64 ONE-CLICK COMPLETE"
